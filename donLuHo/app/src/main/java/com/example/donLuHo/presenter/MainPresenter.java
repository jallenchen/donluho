...
public class MainPresenter extends BaseDetailPresenter<MainViewable> {
    @Override
    ...
    public void checkVersionUpdate() {
        ...
        onCallHttpRequest(HttpServiceGenerator.create(API.class).checkVersionUpdate(map), new HttpResultObserver<UpdateBean>(){
            @Override
            public void onHttpSuccess(UpdateBean result, String msg) {
                super.onHttpSuccess(result, msg);
                getView().onCheckVersionUpdate(result);
            }
        });
